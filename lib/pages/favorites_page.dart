                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: ElevatedButton(
                                                onPressed: () {
                                                  ...
                                                  if (data == null || data.isEmpty) {
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      SnackBar(
                                                        content: Text("Không thể thêm vào giỏ hàng: Dữ liệu sản phẩm không hợp lệ"),
                                                  ...
                                                  try {
                                                    // Tạo đối tượng CartItem trực tiếp
                                                    double priceValue = double.tryParse(data["ProductPrice"] ?? "0") ?? 0.0;
                                                    ...
                                                    // Thêm vào giỏ hàng sử dụng CartService
                                                ...
                                                child: Text("Thêm vào giỏ", style: TextStyle(color: Colors.white),),
                                              ),
                                            ),
                                            SizedBox(width: 8),
